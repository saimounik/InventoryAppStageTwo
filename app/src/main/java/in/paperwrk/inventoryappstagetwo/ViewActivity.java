package in.paperwrk.inventoryappstagetwo;
...
import in.paperwrk.inventoryappstagetwo.InventoryContract.InventoryEntry;
        ...
        if (cursor.moveToFirst()) {
            ...
            switch (currentSupplierName) {
                ...
                case InventoryEntry.SUPPLIER_OBEIKAN:
                    mProductSupplieNameSpinner.setText(getText(R.string.supplier_myntra));
                    break;
                default:
